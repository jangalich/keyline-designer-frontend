 ...
 *
 *
 * NOTHING BELOW THE ROWS. The report used to be offered here, under the last
 * row, and read as a step that had lost its number: the rail is a progress
 * indicator and the report is not a step in it. It is offered where a
 * finished design's attention already is -- the action area -- by
 * DeliveryPanel.jsx.
 */
